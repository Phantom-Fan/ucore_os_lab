...
alloc_proc(void) {
     ...
     */
    //LAB8:EXERCISE2 2013011321 HINT:need add some code to init fs in proc_struct, ...
...
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
    ...
    ret = -E_NO_MEM;
    //LAB4:EXERCISE2 2013011321
    //LAB8:EXERCISE2 2013011321  HINT:how to copy the fs in parent's proc_struct?
    /*
	...
	//LAB5 2013011321 : (update LAB4 steps)
   /* Some Functions
...
load_icode(int fd, int argc, char **kargv) {
    /* LAB8:EXERCISE2 2013011321  HINT:how to load the file with handler fd  in to process's memory? how to setup argc/argv?
     * MACROs or Functions:
